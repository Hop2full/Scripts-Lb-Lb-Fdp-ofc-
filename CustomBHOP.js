...
function CustomBHop() {
  ...
  var jumpH = value.createFloat("jumpH", 0.2, -0.5, 2);
  var jumpHClip = value.createFloat("jumpHClip", 0, -0.5, 5);
  var upYType = value.createList("upYType", ["Add", "Set", "Times"], "Add");
  var upY = value.createFloat("upY", 0, -3, 2);
  var upHType = value.createList("upHType", ["Add", "Set", "Times"], "Add");
  var upH = value.createFloat("upH",0 , -0.5, 2);
  var upTimer = value.createFloat("upTimer", 1, 0.1, 2);
  var upAirSpeed = value.createFloat("upAirSpeed", 0.02, -0.5, 2);
  var downYType = value.createList("downYType", ["Add", "Set", "Times"], "Add");
  var downY = value.createFloat("downY", 0, -2, 2);
  var downHType = value.createList("downHType", ["Add", "Set", "Times"], "Add");
  var downH = value.createFloat("downH", 0, -0.5, 2);
  var downTimer = value.createFloat("downTimer", 1, 0.1, 2);
  var downAirSpeed = value.createFloat("downAirSpeed", 0.02, -0.5, 2);
  var beforeYType = value.createList("beforeYType", ["Add", "Set", "Times"], "Add");
  var beforeY = value.createFloat("beforeY", 0, -3, 2);
  var beforeHType = value.createList("beforeHType", ["Add", "Set", "Times"], "Add");
  var beforeH = value.createFloat("beforeH",0 , -0.5, 2);
  var beforeTimer = value.createFloat("beforeTimer", 1, 0.1, 2);
  var beforeAirSpeed = value.createFloat("beforeAirSpeed", 0.02, -0.5, 2);
  var ticksAction = value.createInteger("ticksAction", 0, 0, 20);
  var whenYType = value.createList("whenYType", ["Add", "Set", "Times"], "Add");
  var whenY = value.createFloat("whenY", 0, -3, 2);
  var whenHType = value.createList("whenHType", ["Add", "Set", "Times"], "Add");
  var whenH = value.createFloat("whenH",0 , -0.5, 2);
  var whenTimer = value.createFloat("whenTimer", 1, 0.1, 2);
  var whenAirSpeed = value.createFloat("whenAirSpeed", 0.02, -0.5, 2);
  var afterYType = value.createList("afterYType", ["Add", "Set", "Times"], "Add");
  var afterY = value.createFloat("afterY", 0, -3, 2);
  var afterHType = value.createList("afterHType", ["Add", "Set", "Times"], "Add");
  var afterH = value.createFloat("afterH",0 , -0.5, 2);
  var afterTimer = value.createFloat("afterTimer", 1, 0.1, 2);
  var afterAirSpeed = value.createFloat("afterAirSpeed", 0.02, -0.5, 2);
  var ticks;
